    ...
    <div className="flex items-center justify-center flex-col max-h-[77.5vh]">
      <div className={`w-[90vw] h-[679px] m rounded-2xl`} style={{ background: `url('/${props.image}')` }}>
        <div className="h-full w-full bg-[#1a1a1cb5] rounded-2xl flex flex-col justify-center items-center">
          ...
          <div
            className="text-[#ffffff] text-2xl bg-[#3B82F6] rounded-2xl py-2 mobile:scale-[0.8] px-10 m-4 flex text-center mobile:text-[1rem] font-bold"
            style={{
              boxShadow:
                'inset 0px -5.33333px 8px rgba(0, 0, 0, 0.25), inset 0.666667px 5.33333px 8px 2.66667px rgba(0, 0, 0, 0.25)',
            }}
          >
