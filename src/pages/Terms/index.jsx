            ...
            <div className="floating-card p-8 md:p-12">
              ...
              <section className="mb-12">
                ...
                <p className="text-lg text-gray-600 dark:text-gray-300 mb-4">
                  These Terms of Service ("Terms") govern your access to and use of ZESHO platform ("Service") 
                  operated by ZESHO ("us", "we", or "our").
                </p>
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      You must be at least 13 years old to use our Service. By using the Service, 
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      ...
                      these Terms. Our platform is designed for educational purposes and collaborative learning.
                    </p>
                  </div>
                </div>
              </section>
              ...
              <section className="mb-12">
                <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-6">Content and Intellectual Property</h2>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      Our platform, including its design, features, and proprietary content, 
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      ...
                      copyright@zesho.edu with detailed information.
                    </p>
                  </div>
                </div>
              </section>
              ...
              <section className="mb-12">
                <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-6">Disclaimer and Limitation of Liability</h2>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      While we encourage quality educational content, we cannot verify the accuracy 
                      of all materials shared by users. Use educational resources at your own discretion 
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      To the maximum extent permitted by law, ZESHO shall not be liable for any 
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      ...
                      delete your account and associated data in accordance with our data retention policy.
                    </p>
                  </div>
                </div>
              </section>
              ...
              {/* Governing Law */}
              <section className="mb-12">
                <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-6">Governing Law and Dispute Resolution</h2>
                <p className="text-gray-600 dark:text-gray-300 mb-4">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  If a dispute cannot be resolved through negotiation, it may be subject to 
                  binding arbitration or resolved in appropriate courts, depending on applicable law.
                </p>
              </section>
              ...
              <section className="mb-12 p-6 bg-violet-50 dark:bg-violet-900/20 rounded-2xl">
                ...
                <div className="space-y-2 text-gray-600 dark:text-gray-300">
                  <p><strong>Email:</strong> legal@zesho.edu</p>
                  <p><strong>Support:</strong> support@zesho.edu</p>
                  <p><strong>Address:</strong> ZESHO Platform, Innovation Campus, Tech District</p>
                  <p><strong>Website:</strong> www.zesho.edu</p>
                </div>
              </section>
              ...
              <section className="p-6 bg-gradient-to-r from-violet-100 to-purple-100 dark:from-violet-900/30 dark:to-purple-900/30 rounded-2xl">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  By using ZESHO platform, you acknowledge that you have read, understood, 
