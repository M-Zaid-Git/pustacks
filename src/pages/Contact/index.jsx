  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-purple-50 to-blue-50 dark:from-slate-900 dark:via-purple-900 dark:to-slate-900">
        ...
        <div className="relative container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Have questions, suggestions, or need support? We're here to help you make the most of your learning
              journey.
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div>
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 mb-8">
                Whether you're a student seeking help, an educator wanting to contribute, or just curious about our
                platform, we'd love to hear from you. Our team is dedicated to supporting your educational journey.
              </p>
              ...
              <div>
                ...
                <div className="flex space-x-4">
                  <a
                    href="https://zaidx.me"
                    className="w-12 h-12 bg-gradient-to-br from-violet-500 to-purple-600 rounded-xl flex items-center justify-center text-white hover:scale-110 transition-transform duration-300"
                  ...
                  >
                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path
                        ...
                        strokeLinejoin="round"
                        strokeWidth={2}
                        d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9v-9m0 9c0-9-3-9-9-9m9 9c0-9 3-9 9-9"
                      />
                    </svg>
                  </a>
                  <a
                    href="https://github.com/M-Zaid-Git/"
                    className="w-12 h-12 bg-gray-900 dark:bg-gray-700 rounded-xl flex items-center justify-center text-white hover:scale-110 transition-transform duration-300"
                  >
                  ...
                  <a
                    href="https://www.linkedin.com/in/zaidx/"
                  ...
                  <a
                    href="https://www.instagram.com/zaidx.me"
      ...
      <div className="py-16 bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-6 text-gray-900 dark:text-white">Frequently Asked Questions</h2>
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            <div className="floating-card p-6">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4">How do I upload resources?</h3>
              <p className="text-gray-600 dark:text-gray-300">
                Simply create an account, go to your dashboard, and click "Upload Resource." You can upload PDFs,
                documents, presentations, and more.
              </p>
            </div>

            <div className="floating-card p-6">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4">Is ZESHO free to use?</h3>
              <p className="text-gray-600 dark:text-gray-300">
            ...
            <div className="floating-card p-6">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                You can report any content by clicking the report button on the resource page or contacting our support
                team directly.
              </p>
            </div>

            <div className="floating-card p-6">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4">Can I contribute as an educator?</h3>
              <p className="text-gray-600 dark:text-gray-300">
                Absolutely! We welcome educators to share their materials and expertise with our global student
                community.
              </p>
            </div>
          </div>
