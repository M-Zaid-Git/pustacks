...
const materialSchema = new mongoose.Schema({
  ...
  fileType: { type: String, required: true, enum: ['pdf', 'doc', 'docx', 'ppt', 'pptx', 'xlsx', 'txt', 'image', 'video', 'audio', 'zip', 'other'] },
  ...
  category: { 
    type: String, 
    required: true, 
    enum: ['notes', 'assignments', 'exams', 'books', 'papers', 'presentations', 'coding', 'tutorials', 'research', 'projects', 'other'] 
  },
...
const activitySchema = new mongoose.Schema({
  ...
  action: { 
    type: String, 
    enum: ['upload', 'download', 'bookmark', 'comment', 'rate', 'follow', 'join_group', 'complete_goal', 'earn_badge', 'register', 'update_profile', 'update_goals', 'logout'], 
    required: true 
  },
